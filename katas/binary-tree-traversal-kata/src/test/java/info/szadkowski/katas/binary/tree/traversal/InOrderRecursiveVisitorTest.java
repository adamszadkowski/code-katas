...
class InOrderRecursiveVisitorTest {
  private String visitedNodes = "";

  private BinaryTreeParser<Node> parser;
  private InOrderRecursiveVisitor<Node> visitor;

  @BeforeEach
  void setUp() {
    parser = new BinaryTreeParser<>(Node::new);
    visitor = new InOrderRecursiveVisitor<>(Node::getLeft, Node::getRight, Node::visit);
  }
